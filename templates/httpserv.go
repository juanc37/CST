...
func main() {
	...
	users = append(users, User{ID: "1", EncrPass: "secret", Email: "jc3fake@gmail.com", Firstname: "Juan", Lastname: "C3", Location: &Location{State: "CA", Zip: "92129"}})
	users = append(users, User{ID: "2", EncrPass: "secret",Email: "zakydfake@gmail.com", Firstname: "Zaky", Lastname: "Demnianiek"})
